...
contains
   ...
   subroutine ec_ice_optics_sw(nday, cicewp, rei, cldn, ice_tau, ice_tau_w, ice_tau_w_g, ice_tau_w_f)
   ...
   subroutine ec_ice_optics_lw(ncol, iciwpth, iclwpth, rei, cldn, abs_od)

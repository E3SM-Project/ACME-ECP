...
program flux_compute
  ...
  use mo_gas_concentrations,       &
                        only: ty_gas_concs
  use mo_spectral_disc, &
                        only: ty_spectral_disc
  ...
  use mo_test_files_io,     only: read_atmos, is_lw, is_sw, &
                                  ...
                                  read_direction, read_optical_props, read_spectral_disc, &
                                  read_lw_rt,  &
  ...
  class(ty_optical_props_arry), target, &
                        allocatable :: atmos, atmos_subset
  ...
  call read_spectral_disc(input_file, spectral_disc)
  call read_optical_props(input_file, atmos)
  ...
  if(is_lw(input_file)) then
    ...
    call read_lw_Planck_sources(input_file, lay_src, lev_src_inc, lev_src_dec, sfc_src)
  ...
  !
  call write_spectral_disc(input_file, spectral_disc)

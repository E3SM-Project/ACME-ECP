...
python ../test/run_tests.py --root .. --no_diff --test make-general-clear-problems.ini

#
# Fluxes with SHDOM 
#
# Longwave clear-sky fluxes for uniform and variable BCs (this takes a few minutes)
python ../test/run_tests.py --root .. --no_diff --test run-shdompp-lw-gen-clear.ini
# Shortwave clear-sky fluxes for uniform and variable BCs (about 15 minutes)
python ../test/run_tests.py --root .. --no_diff --test run-shdompp-sw-gen-clear.ini
...
python ../test/run_tests.py --root .. --no_diff --test run-rrtmgp-gen-clear.ini

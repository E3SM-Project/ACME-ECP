...
python ../test/run_tests.py --root .. --no_diff --test run-shdompp-lw-clear.ini
# Shortwave clear-sky fluxes (about 8 minutes)
python ../test/run_tests.py --root .. --no_diff --test run-shdompp-sw-clear.ini
...
python ../test/run_tests.py --root .. --no_diff --test run-rrtmgp-clear.ini

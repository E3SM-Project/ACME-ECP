...
!-----------------------------------------------------------------------
   ...
   real(r8), intent(out) :: fus(pcols,pverp)   ! upward flux at interfaces
   real(r8), intent(out) :: fds(pcols,pverp)   ! downward flux at interfaces
   real(r8), intent(out) :: fns(pcols,pverp)   ! net flux at interfaces
   real(r8), intent(out) :: fusc(pcols,pverp)  ! upward clear-sky flux at interfaces
   real(r8), intent(out) :: fdsc(pcols,pverp)  ! downward clear-sky flux at interfaces
   ...
   fusc(1:ncol,1:pverp) = 0.0_r8
   fdsc(1:ncol,1:pverp) = 0.0_r8

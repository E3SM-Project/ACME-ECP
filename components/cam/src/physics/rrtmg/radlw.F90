...
!
   ...
   real(r8), intent(out) :: ful(pcols,pverp)     ! upward flux at interfaces
   real(r8), intent(out) :: fdl(pcols,pverp)     ! downward flux at interfaces
   real(r8), intent(out) :: fnl(pcols,pverp)     ! net flux at interfaces
   real(r8), intent(out) :: fulc(pcols,pverp)    ! clear-sky upward flux at interfaces
   real(r8), intent(out) :: fdlc(pcols,pverp)    ! clear-sky downward flux at interfaces
...
!
   ...
   if (single_column.and.scm_crm_mode) then
      ...
      call outfld('FULC    ',fulc,pcols,lchnk)
      call outfld('FDLC    ',fdlc,pcols,lchnk)
   endif

module vars
  ...
  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  !! The following block is evidently allocate elsewhere and will not be allocated here
  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  !! End block that's allocated elsewhere
  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  real(crm_rknd) :: s_cldtauisccp,s_cldtaumodis,s_cldtaulmodis,s_cldtauimodis,s_cldalbisccp
  real(crm_rknd) :: s_flns,s_flnt,s_flntoa,s_flnsc,s_flntoac,s_flds,s_fsns
  real(crm_rknd) :: s_fsnt,s_fsntoa,s_fsnsc,s_fsntoac,s_fsds,s_solin
...
contains
  ...
  subroutine allocate_vars()
    ...
    allocate( p      (0:nx,(1-YES3D):ny,nzm) )
    ...
    allocate( utend(nzm) )
    allocate( vtend(nzm) )
    ! real(crm_rknd), allocatable :: dqls(:,:)
    ! real(crm_rknd), allocatable :: dtls(:,:)
    ! real(crm_rknd), allocatable :: ugls(:,:)
    ! real(crm_rknd), allocatable :: vgls(:,:)
    ! real(crm_rknd), allocatable :: wgls(:,:)
    ! real(crm_rknd), allocatable :: pres0ls(:)
    ! real(crm_rknd), allocatable :: zls(:,:)
    ! real(crm_rknd), allocatable :: pls(:,:)
    ! real(crm_rknd), allocatable :: dayls(:)
    ! real(crm_rknd), allocatable :: dtrfc(:,:)
    ! real(crm_rknd), allocatable :: dayrfc(:)
    ! real(crm_rknd), allocatable :: prfc(:,:)
    ! real(crm_rknd), allocatable :: sstsfc(:)
    ! real(crm_rknd), allocatable :: shsfc(:)
    ! real(crm_rknd), allocatable :: lhsfc(:)
    ! real(crm_rknd), allocatable :: tausfc(:)
    ! real(crm_rknd), allocatable :: daysfc(:)
    ! real(crm_rknd), allocatable :: usnd(:,:)
    ! real(crm_rknd), allocatable :: vsnd(:,:)
    ! real(crm_rknd), allocatable :: tsnd(:,:)
    ! real(crm_rknd), allocatable :: qsnd(:,:)
    ! real(crm_rknd), allocatable :: zsnd(:,:)
    ! real(crm_rknd), allocatable :: psnd(:,:)
    ! real(crm_rknd), allocatable :: daysnd(:)
    ...
    ! real(crm_rknd), allocatable :: condavg_factor(:,:)
    ! real(crm_rknd), allocatable :: condavg_mask(:,:,:,:)
    ! character(LEN=8), allocatable :: condavgname(:)
    ! character(LEN=25), allocatable :: condavglongname(:)

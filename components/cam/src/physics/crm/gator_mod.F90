...
module gator_mod
  ...
  interface
    subroutine gator_init_c( bytes ) bind(C, name="gatorInit")
      use iso_c_binding
  ...
  interface
    subroutine gator_finalize_c( ) bind(C, name="gatorFinalize")
    end subroutine gator_finalize_c
  end interface
  ...
  interface gator_init
    module procedure :: gator_init_int4
    module procedure :: gator_init_int8
...
contains
  ...
  !! gator_init
  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  subroutine gator_init_int4( bytes )
    integer(4) :: bytes
    call gator_init_c( int(bytes,c_size_t) )
  end subroutine gator_init_int4
  subroutine gator_init_int8( bytes )
    integer(8) :: bytes
    call gator_init_c( int(bytes,c_size_t) )
  end subroutine gator_init_int8
  ...
  !! gator_finalize
  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  subroutine gator_finalize()
    call gator_finalize_c()

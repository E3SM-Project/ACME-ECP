...
program crm_standalone
  ...
  do i = 1 , ncols
    call dmdf_write(crm_tk          (:,:,:,  i),rank,'csa_out',trim('crm_tk          '),(/'crm_nx','crm_ny','crm_nz'/)                   ,.true. ,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(crm_tkh         (:,:,:,  i),rank,'csa_out',trim('crm_tkh         '),(/'crm_nx','crm_ny','crm_nz'/)                   ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(cltot           (        i),rank,'csa_out',trim('cltot           ')                                                  ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(clhgh           (        i),rank,'csa_out',trim('clhgh           ')                                                  ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(clmed           (        i),rank,'csa_out',trim('clmed           ')                                                  ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(cllow           (        i),rank,'csa_out',trim('cllow           ')                                                  ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(sltend          (:,      i),rank,'csa_out',trim('sltend          '),(/'plev'/)                                       ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(u_crm           (:,:,:,  i),rank,'csa_out',trim('u_crm           '),(/'crm_nx','crm_ny','crm_nz'/)                   ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(v_crm           (:,:,:,  i),rank,'csa_out',trim('v_crm           '),(/'crm_nx','crm_ny','crm_nz'/)                   ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(w_crm           (:,:,:,  i),rank,'csa_out',trim('w_crm           '),(/'crm_nx','crm_ny','crm_nz'/)                   ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(t_crm           (:,:,:,  i),rank,'csa_out',trim('t_crm           '),(/'crm_nx','crm_ny','crm_nz'/)                   ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(micro_fields_crm(:,:,:,:,i),rank,'csa_out',trim('micro_fields_crm'),(/'crm_nx          ','crm_ny          ','crm_nz          ','nmicro_fields_p1'/),.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(qltend          (:,      i),rank,'csa_out',trim('qltend          '),(/'plev'/)                                       ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(qcltend         (:,      i),rank,'csa_out',trim('qcltend         '),(/'plev'/)                                       ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(qiltend         (:,      i),rank,'csa_out',trim('qiltend         '),(/'plev'/)                                       ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(t_rad           (:,:,:,  i),rank,'csa_out',trim('t_rad           '),(/'crm_nx','crm_ny','crm_nz'/)                   ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(qv_rad          (:,:,:,  i),rank,'csa_out',trim('qv_rad          '),(/'crm_nx','crm_ny','crm_nz'/)                   ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(qc_rad          (:,:,:,  i),rank,'csa_out',trim('qc_rad          '),(/'crm_nx','crm_ny','crm_nz'/)                   ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(qi_rad          (:,:,:,  i),rank,'csa_out',trim('qi_rad          '),(/'crm_nx','crm_ny','crm_nz'/)                   ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(cld_rad         (:,:,:,  i),rank,'csa_out',trim('cld_rad         '),(/'crm_nx','crm_ny','crm_nz'/)                   ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(cld3d_crm       (:,:,:,  i),rank,'csa_out',trim('cld3d_crm       '),(/'crm_nx','crm_ny','crm_nz'/)                   ,.false.,.false.); _ERR(success,error_string,__LINE__)
#ifdef CRM3D
    call dmdf_write(ultend          (:,      i),rank,'csa_out',trim('ultend          '),(/'plev'/)                                       ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(vltend          (:,      i),rank,'csa_out',trim('vltend          '),(/'plev'/)                                       ,.false.,.false.); _ERR(success,error_string,__LINE__)
#endif
#ifdef m2005
    call dmdf_write(nc_rad          (:,:,:,  i),rank,'csa_out',trim('nc_rad          '),(/'crm_nx','crm_ny','crm_nz'/)                   ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(ni_rad          (:,:,:,  i),rank,'csa_out',trim('ni_rad          '),(/'crm_nx','crm_ny','crm_nz'/)                   ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(qs_rad          (:,:,:,  i),rank,'csa_out',trim('qs_rad          '),(/'crm_nx','crm_ny','crm_nz'/)                   ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(ns_rad          (:,:,:,  i),rank,'csa_out',trim('ns_rad          '),(/'crm_nx','crm_ny','crm_nz'/)                   ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(wvar_crm        (:,:,:,  i),rank,'csa_out',trim('wvar_crm        '),(/'crm_nx','crm_ny','crm_nz'/)                   ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(aut_crm         (:,:,:,  i),rank,'csa_out',trim('aut_crm         '),(/'crm_nx','crm_ny','crm_nz'/)                   ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(acc_crm         (:,:,:,  i),rank,'csa_out',trim('acc_crm         '),(/'crm_nx','crm_ny','crm_nz'/)                   ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(evpc_crm        (:,:,:,  i),rank,'csa_out',trim('evpc_crm        '),(/'crm_nx','crm_ny','crm_nz'/)                   ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(evpr_crm        (:,:,:,  i),rank,'csa_out',trim('evpr_crm        '),(/'crm_nx','crm_ny','crm_nz'/)                   ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(mlt_crm         (:,:,:,  i),rank,'csa_out',trim('mlt_crm         '),(/'crm_nx','crm_ny','crm_nz'/)                   ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(sub_crm         (:,:,:,  i),rank,'csa_out',trim('sub_crm         '),(/'crm_nx','crm_ny','crm_nz'/)                   ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(dep_crm         (:,:,:,  i),rank,'csa_out',trim('dep_crm         '),(/'crm_nx','crm_ny','crm_nz'/)                   ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(con_crm         (:,:,:,  i),rank,'csa_out',trim('con_crm         '),(/'crm_nx','crm_ny','crm_nz'/)                   ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(aut_crm_a       (:,      i),rank,'csa_out',trim('aut_crm_a       '),(/'plev'/)                                       ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(acc_crm_a       (:,      i),rank,'csa_out',trim('acc_crm_a       '),(/'plev'/)                                       ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(evpc_crm_a      (:,      i),rank,'csa_out',trim('evpc_crm_a      '),(/'plev'/)                                       ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(evpr_crm_a      (:,      i),rank,'csa_out',trim('evpr_crm_a      '),(/'plev'/)                                       ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(mlt_crm_a       (:,      i),rank,'csa_out',trim('mlt_crm_a       '),(/'plev'/)                                       ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(sub_crm_a       (:,      i),rank,'csa_out',trim('sub_crm_a       '),(/'plev'/)                                       ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(dep_crm_a       (:,      i),rank,'csa_out',trim('dep_crm_a       '),(/'plev'/)                                       ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(con_crm_a       (:,      i),rank,'csa_out',trim('con_crm_a       '),(/'plev'/)                                       ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(crm_nc          (:,      i),rank,'csa_out',trim('crm_nc          '),(/'plev'/)                                       ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(crm_ni          (:,      i),rank,'csa_out',trim('crm_ni          '),(/'plev'/)                                       ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(crm_ns          (:,      i),rank,'csa_out',trim('crm_ns          '),(/'plev'/)                                       ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(crm_ng          (:,      i),rank,'csa_out',trim('crm_ng          '),(/'plev'/)                                       ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(crm_nr          (:,      i),rank,'csa_out',trim('crm_nr          '),(/'plev'/)                                       ,.false.,.false.); _ERR(success,error_string,__LINE__)
#endif
    call dmdf_write(precc           (        i),rank,'csa_out',trim('precc           ')                                                  ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(precl           (        i),rank,'csa_out',trim('precl           ')                                                  ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(cld             (:,      i),rank,'csa_out',trim('cld             '),(/'plev'/)                                       ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(cldtop          (:,      i),rank,'csa_out',trim('cldtop          '),(/'plev'/)                                       ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(gicewp          (:,      i),rank,'csa_out',trim('gicewp          '),(/'plev'/)                                       ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(gliqwp          (:,      i),rank,'csa_out',trim('gliqwp          '),(/'plev'/)                                       ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(mc              (:,      i),rank,'csa_out',trim('mc              '),(/'plev'/)                                       ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(mcup            (:,      i),rank,'csa_out',trim('mcup            '),(/'plev'/)                                       ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(mcdn            (:,      i),rank,'csa_out',trim('mcdn            '),(/'plev'/)                                       ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(mcuup           (:,      i),rank,'csa_out',trim('mcuup           '),(/'plev'/)                                       ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(mcudn           (:,      i),rank,'csa_out',trim('mcudn           '),(/'plev'/)                                       ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(crm_qc          (:,      i),rank,'csa_out',trim('crm_qc          '),(/'plev'/)                                       ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(crm_qi          (:,      i),rank,'csa_out',trim('crm_qi          '),(/'plev'/)                                       ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(crm_qs          (:,      i),rank,'csa_out',trim('crm_qs          '),(/'plev'/)                                       ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(crm_qg          (:,      i),rank,'csa_out',trim('crm_qg          '),(/'plev'/)                                       ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(crm_qr          (:,      i),rank,'csa_out',trim('crm_qr          '),(/'plev'/)                                       ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(mu_crm          (:,      i),rank,'csa_out',trim('mu_crm          '),(/'plev'/)                                       ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(md_crm          (:,      i),rank,'csa_out',trim('md_crm          '),(/'plev'/)                                       ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(du_crm          (:,      i),rank,'csa_out',trim('du_crm          '),(/'plev'/)                                       ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(eu_crm          (:,      i),rank,'csa_out',trim('eu_crm          '),(/'plev'/)                                       ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(ed_crm          (:,      i),rank,'csa_out',trim('ed_crm          '),(/'plev'/)                                       ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(dd_crm          (:,      i),rank,'csa_out',trim('dd_crm          '),(/'plev'/)                                       ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(jt_crm          (        i),rank,'csa_out',trim('jt_crm          ')                                                  ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(mx_crm          (        i),rank,'csa_out',trim('mx_crm          ')                                                  ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(mui_crm         (:,      i),rank,'csa_out',trim('mui_crm         '),(/'plev_p1'/)                                    ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(mdi_crm         (:,      i),rank,'csa_out',trim('mdi_crm         '),(/'plev_p1'/)                                    ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(flux_qt         (:,      i),rank,'csa_out',trim('flux_qt         '),(/'plev'/)                                       ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(fluxsgs_qt      (:,      i),rank,'csa_out',trim('fluxsgs_qt      '),(/'plev'/)                                       ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(tkez            (:,      i),rank,'csa_out',trim('tkez            '),(/'plev'/)                                       ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(tkesgsz         (:,      i),rank,'csa_out',trim('tkesgsz         '),(/'plev'/)                                       ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(tkz             (:,      i),rank,'csa_out',trim('tkz             '),(/'plev'/)                                       ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(flux_u          (:,      i),rank,'csa_out',trim('flux_u          '),(/'plev'/)                                       ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(flux_v          (:,      i),rank,'csa_out',trim('flux_v          '),(/'plev'/)                                       ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(flux_qp         (:,      i),rank,'csa_out',trim('flux_qp         '),(/'plev'/)                                       ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(pflx            (:,      i),rank,'csa_out',trim('pflx            '),(/'plev'/)                                       ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(qt_ls           (:,      i),rank,'csa_out',trim('qt_ls           '),(/'plev'/)                                       ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(qt_trans        (:,      i),rank,'csa_out',trim('qt_trans        '),(/'plev'/)                                       ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(qp_trans        (:,      i),rank,'csa_out',trim('qp_trans        '),(/'plev'/)                                       ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(qp_fall         (:,      i),rank,'csa_out',trim('qp_fall         '),(/'plev'/)                                       ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(qp_src          (:,      i),rank,'csa_out',trim('qp_src          '),(/'plev'/)                                       ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(qp_evp          (:,      i),rank,'csa_out',trim('qp_evp          '),(/'plev'/)                                       ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(t_ls            (:,      i),rank,'csa_out',trim('t_ls            '),(/'plev'/)                                       ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(prectend        (        i),rank,'csa_out',trim('prectend        ')                                                  ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(precstend       (        i),rank,'csa_out',trim('precstend       ')                                                  ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(precsc          (        i),rank,'csa_out',trim('precsc          ')                                                  ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(precsl          (        i),rank,'csa_out',trim('precsl          ')                                                  ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(taux_crm        (        i),rank,'csa_out',trim('taux_crm        ')                                                  ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(tauy_crm        (        i),rank,'csa_out',trim('tauy_crm        ')                                                  ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(z0m             (        i),rank,'csa_out',trim('z0m             ')                                                  ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(timing_factor   (        i),rank,'csa_out',trim('timing_factor   ')                                                  ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(qc_crm          (:,:,:,  i),rank,'csa_out',trim('qc_crm          '),(/'crm_nx','crm_ny','crm_nz'/)                   ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(qi_crm          (:,:,:,  i),rank,'csa_out',trim('qi_crm          '),(/'crm_nx','crm_ny','crm_nz'/)                   ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(qpc_crm         (:,:,:,  i),rank,'csa_out',trim('qpc_crm         '),(/'crm_nx','crm_ny','crm_nz'/)                   ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(qpi_crm         (:,:,:,  i),rank,'csa_out',trim('qpi_crm         '),(/'crm_nx','crm_ny','crm_nz'/)                   ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(prec_crm        (:,:,    i),rank,'csa_out',trim('prec_crm        '),(/'crm_nx','crm_ny'/)                            ,.false.,.false.); _ERR(success,error_string,__LINE__)
    call dmdf_write(qtot            (:,      i),rank,'csa_out',trim('qtot            '),(/'d20'/)                                        ,.false.,.true. ); _ERR(success,error_string,__LINE__)
  enddo

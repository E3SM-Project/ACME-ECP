...
module random_mt
   ...
   public random_mt_set_seed
   public random_mt_gen_rand
...
!
subroutine random_mt_set_seed(seed)
#if defined(_OPENMP)
   !$omp declare target
#endif
   implicit none
...
end subroutine random_mt_set_seed
!-----------------------------------------------------------------------
!-----------------------------------------------------------------------
subroutine random_mt_gen_rand(grnd)
#if defined(_OPENMP)
   !$omp declare target
#endif
   implicit none
   real(crm_rknd), intent(out) :: grnd
   integer :: y, kk
...
end subroutine random_mt_gen_rand
!-----------------------------------------------------------------------
!-----------------------------------------------------------------------
end module random_mt

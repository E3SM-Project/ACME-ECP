...
!   REAL, SAVE :: NNUCCD_REDUCE_COEF = 1.0, NNUCCC_REDUCE_COEF = 1.0
   REAL, SAVE :: NNUCCD_REDUCE_COEF = 1.0, NNUCCC_REDUCE_COEF = 1.0e-2
#endif
...
! ADDED BY UWM JAN 7 2008
      ...
      REAL, INTENT(IN), DIMENSION(KMS:KME) ::  CFL3D  ! SUBGRID SCALE LIQUID CLOUD FRACTION 
      REAL, INTENT(IN), DIMENSION(KMS:KME) ::  CFI3D  ! SUBGRID SCALE ICE CLOUD FRACTION (total cloud fraction here) 
      REAL, INTENT(IN), DIMENSION(KMS:KME) ::  RELVAR  ! RELATIVE LIQUID WATER VARIANCE
      REAL, INTENT(IN), DIMENSION(KMS:KME) ::  ACCRE_ENHAN  ! ACCRETION ENHANCEMENT FACTOR 
#endif
! OUTPUT VARIABLES
...
! new variables for seifert and beheng warm rain scheme
      ...
      REAL :: CLDMAXR(KMS:KME)  ! Maximum cloudoverlap for rain water
      REAL :: CLDMAXALL(KMS:KME)  ! Maximum cloudoverlap for all hydrometers
#else 

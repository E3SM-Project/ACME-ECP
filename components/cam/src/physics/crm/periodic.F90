...
contains
  ...
  subroutine periodic(ncrms,icrm,flag)
    ...
    if(flag.eq.2) then
      ...
      do i = 1,nsgs_fields
        ...
        call bound_exchange(sgs_field(:,:,:,icrm,i),dimx1_s,dimx2_s,dimy1_s,dimy2_s,nzm, &
      ...
      do i = 1,nmicro_fields
        ...
        .or. (docloud.or.doclubb.or.doclubbnoninter) .and.flag_precip(i,icrm).ne.1    &
#else
        .or. docloud.and.flag_precip(i,icrm).ne.1    &
#endif
        .or. doprecip.and.flag_precip(i,icrm).eq.1 ) &
    ...
    if(flag.eq.4) then
      ...
      do i = 1,nsgs_fields_diag
        ...
        call bound_exchange(sgs_field_diag(:,:,:,icrm,i),dimx1_d,dimx2_d,dimy1_d,dimy2_d,nzm, &

...
!--------------------------------------------------
  ...
  !!$acc enter data copyin(dt3,cwp,cwph,cwpm,cwpl,flag_top,cltemp,cmtemp,chtemp,cttemp,mkadv,mkwle,sgsadv,sgswle,gamaz) async(asyncid)
  !$acc enter data copyin(rhow,uwle,vwle,uwsb,vwsb,gamaz) async(asyncid)
  ...
  do while (nstep < nstop)
    ...
    do icyc=1,ncycle
      icycle = icyc
      dtn = dt/ncycle
      !$acc parallel copy(dt3) async(asyncid)
      dt3(na) = dtn
      !$acc end parallel
      dtfactor = dtn/dt
  ...
  !!$acc exit data copyout(dt3,cwp,cwph,cwpm,cwpl,flag_top,cltemp,cmtemp,chtemp,cttemp,mkadv,mkwle,sgsadv,sgswle,gamaz) async(asyncid)
  !$acc exit data copyout(rhow,uwle,vwle,uwsb,vwsb,gamaz) async(asyncid)

...
!--------------------------------------------------
  ...
  !!$acc enter data copyin(cwp,cwph,cwpm,cwpl,flag_top,cltemp,cmtemp,chtemp,cttemp,sgsadv,sgswle) async(asyncid)
  ...
  !!$acc exit data copyout(cwp,cwph,cwpm,cwpl,flag_top,cltemp,cmtemp,chtemp,cttemp,sgsadv,sgswle) async(asyncid)

...
! #endif
    ...
    ! ultend_esmt(icrm,:) = (uln - ul(icrm,:))*idt_gl
    ! vltend_esmt(icrm,:) = (vln - vl(icrm,:))*idt_gl
    ultend_esmt(icrm,:) = (uln_esmt(:) - ul_esmt(icrm,:))*idt_gl
    vltend_esmt(icrm,:) = (vln_esmt(:) - vl_esmt(icrm,:))*idt_gl

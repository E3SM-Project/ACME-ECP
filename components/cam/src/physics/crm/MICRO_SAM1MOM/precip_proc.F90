...
contains
  ...
  subroutine precip_proc(ncrms,icrm,qpsrc,qpevp,micro_field,qn)
    ...
    do k=1,nzm
      ...
      do j=1,ny
        do i=1,nx
          ...
          dq = qp(i,j,k,icrm)
          qp(i,j,k,icrm)=max(real(0.,crm_rknd),qp(i,j,k,icrm))

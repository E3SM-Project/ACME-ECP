...
!-- mdb spcam
  ...
  call phys_getopts(use_ECPP_out  = use_ECPP)
   ...
   if (use_SPCAM) then
      ...
      call addfld ('SPTA    ',(/ 'lev' /), 'A', 'K       ','Absolute Temperature from CRM'           )
      call addfld ('SPQV    ',(/ 'lev' /), 'A', 'K       ','Absolute Temperature from CRM'           )
      ...
      call add_default ('SPTA    ', 1, ' ')
      call add_default ('SPQV    ', 1, ' ')

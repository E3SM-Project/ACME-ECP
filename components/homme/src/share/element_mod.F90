...
module element_mod
  ...
  type, public :: element_t
     ...
     real (kind=real_kind) :: T_tend (np,np,nlev)
     real (kind=real_kind) :: qv_tend (np,np,nlev)
     real (kind=real_kind) :: ql_tend (np,np,nlev)
     real (kind=real_kind) :: qi_tend (np,np,nlev)
#endif
